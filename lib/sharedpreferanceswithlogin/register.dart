                        ...
                        onPressed: () async {
                          if (_usernameController.text.isNotEmpty &&
                            ...
                            if (_passwordController.text.isNotEmpty &&
                              ...
                              if (_ageController.text.isNotEmpty &&
                                ...
                                if (_countryController.text.isNotEmpty &&
                                  ...
                                  if (_emailController.text.isNotEmpty &&
                                    ...
                                    ftoast.showToast(
                                      child: checkshow("Created Successfully",Colors.greenAccent) ,
                                    ...
                                    print(
                                      ...
                                      ftoast.showToast(
                                      child: show("Fill your Email",Colors.red) ,
                                      gravity: ToastGravity.BOTTOM,
                                      toastDuration: Duration(seconds: 2),
                                    );
                                  }
                                  ...
                                  ftoast.showToast(
                                    child: show("Fill your Country",Colors.red) ,
                                    gravity: ToastGravity.BOTTOM,
                                    toastDuration: Duration(seconds: 2),
                                  );
                                }
                              ...
                              ftoast.showToast(
                                child: show("Fill your Password \n Or Re_password ",Colors.red) ,
                                gravity: ToastGravity.BOTTOM,
                                toastDuration: Duration(seconds: 2),
                              );
